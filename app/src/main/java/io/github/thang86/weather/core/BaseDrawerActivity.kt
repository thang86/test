...
import io.github.thang86.weather.ui.activity.search.SearchCityActivity
import io.github.thang86.weathers.core.BaseActivity
...
abstract class BaseDrawerActivity : BaseActivity() {
    ...
    private fun startActivity() {
        val searchLocationIntent: Intent = SearchCityActivity.newIntent(applicationContext)
